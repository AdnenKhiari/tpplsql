...
import { EntityArrayResponseType, LaboratoireService } from '../service/laboratoire.service';
...
export class LaboratoireComponent implements OnInit {
  ...
  trackLabno = (_index: number, item: ILaboratoire): number => this.laboratoireService.getLaboratoireIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.laboratoires = this.refineData(dataFromBody);
  }

  protected refineData(data: ILaboratoire[]): ILaboratoire[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: ILaboratoire[] | null): ILaboratoire[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.laboratoireService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
